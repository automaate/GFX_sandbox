...
| ------------- |:-------------:|
| [blank_qs_e70_xu_tm4301b.X](./ip1553/ip1553_bc_operation_blocking/readme.md)| This application runs on the SAM E70 Xplained Ultra Evaluation Kit using LCC software display controller to drive the High-Performance 4.3" WQVGA Display Module with maXTouch® Technology. |
