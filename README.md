...
(https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/DM320005-5) |
| --- | --- | --- | --- | --- | --- |
...
* (new)Project regeneration from command line can remove Aria generated screens and widgets.

* (new) Touch is intermittently working on SSD1963 and SAME70/E54 Aria Quickstart solution

* (new) MHGC GAC does not generated a 2DGPU comaptible palette table. A translation step is required to create word values from little endian byte array. 
